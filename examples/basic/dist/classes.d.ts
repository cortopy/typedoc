 ...
 */
export declare abstract class BaseClass implements INameInterface {
    /**
     ...
     */
    static caTest(originalValues: BaseClass, newRecord: any, fieldNames: string[], mandatoryFields: string[]): string;
}
/**
 ...
 * from BaseClass.
 */
export declare class SubClassA extends BaseClass implements IPrintNameInterface {
    name: string;
    /**
    ...
    */
     ...
     * @returns The return value.
     */
    readonly readOnlyNameProperty: string;
    /**
     * Sets the name. See [[BaseClass.name]].
     *
     * @param value The new name.
 ...
 */
export declare class SubClassB extends BaseClass {
    name: string;
    constructor(name: string);
    abstractMethod(): void;
    doSomething(value: [string, SubClassA, SubClassB]): void;
}
/**
 ...
 */
export declare class GenericClass<T extends BaseClass> {
    protected p2: T;
    p3: number;
    private p4;
    readonly p5: string;
     ...
     */
    constructor(p1: any, p2: T, p3: number, p4: number, p5: string);
    /**
 ...
 */
export declare class NonGenericClass extends GenericClass<SubClassB> {
}
