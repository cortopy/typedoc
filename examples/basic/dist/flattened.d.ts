 ...
 * @param callback.optionalParam  An optional parameter of the typed function callback.
 */
declare function flattenedCallback(callback: (param: number, optionalParam?: string) => string): void;
/**
 ...
 * @param options.moreOptions.moreValues  A value of the typed child object.
 */
declare function flattenedParameter(options: {
    [name: string]: any;
    value?: string;
    anotherValue?: string;
    moreOptions?: {
 ...
 * @param indexed.test   A property of the index signature instance.
 */
declare function flattenedIndexSignature(indexed: {
    [index: number]: {
        name: string;
        value?: number;
    };
